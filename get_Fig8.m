function [SSdata,test] = get_Fig8(delta,days,D,units,inf_type)
...
params = {'k_{int}','k_{rec}', 'k_{lys}','AT1R_{Gl}^{tot}','c_{chym}','c_{NEP}',...
          ...
          'S_{Tb}','k_{AGT}','k_a','B_{AT1R}^{-}','K_{circ_{ACE}}','K_{circ_{AGT}}',...
...
figure(8)
subplot(6,2,1)
heatmap(params(1:13),circRowNames,test_circ(:,1:13),'Colormap',summer,...
...
subplot(6,2,2)
heatmap(params(14:end),circRowNames,test_circ(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
...
subplot(6,2,3)
heatmap(params(1:13),GlRowNames,test_Gl(:,1:13),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],'ColorbarVisible','off',...
        'ColorbarVisible','off');
ylabel('Glomerular')
...
subplot(6,2,4)
heatmap(params(14:end),GlRowNames,test_Gl(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],'ColorbarVisible','off');
set(gca,'fontsize',12);
Ax = gca;
...
subplot(6,2,5)
heatmap(params(1:13),PtRowNames,test_Pt(:,1:13),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...%,...
       'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],...
    'ColorbarVisible','off');
ylabel('Peritubular')
...
subplot(6,2,6)
heatmap(params(14:end),PtRowNames,test_Pt(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')]);
set(gca,'fontsize',12);
Ax = gca;
...
subplot(6,2,7)
heatmap(params(1:13),TbRowNames,test_Tb(:,1:13),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
       'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],...
    'ColorbarVisible','off');
ylabel('Tubular')
...
subplot(6,2,8)
heatmap(params(14:end),TbRowNames,test_Tb(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],'ColorbarVisible','off');
set(gca,'fontsize',12);
Ax = gca;
...
subplot(6,2,9)
heatmap(params(1:13),PvRowNames,test_Pv(:,1:13),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...,...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],...
     'ColorbarVisible','off');  
...
subplot(6,2,10)
heatmap(params(14:end),PvRowNames,test_Pv(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')]);
set(gca,'fontsize',12);
Ax = gca;
...
subplot(6,2,11)
heatmap(params(1:13),WKRowNames,test_WK(:,1:13),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...,...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],...
    'ColorbarVisible','off');  
ylabel({'Whole', 'kidney'})
...
subplot(6,2,12)
heatmap(params(14:end),WKRowNames,test_WK(:,14:end),'Colormap',summer,...
    'MissingDataColor','w','MissingDataLabel','<1%',...
        'ColorLimits',[min(test(1:35,:),[],'all'),max(test(1:35,:),[],'all')],'ColorbarVisible','off');
set(gca,'fontsize',12);
