function [comp_intra_tot, comp_memb_tot, comp_isf_tot, comp_tot] = get_endo_exo_distributions(sim)

% Volumes
V_Gl_Isf = 0.0019;
V_Pt_Isf = 0.0236;
V_Gl_cell = 0.0019;
V_Pv = 0.085; %0.147*0.58;
V_Tb_Fl = 0.102;
V_Tb_Pt_cell = 0.294;
...
comp_intra_tot = [intra_endo' intra_exo'];
comp_memb_tot = [memb_endo' memb_exo'];
comp_isf_tot = [isf_endo' isf_exo'];
comp_tot = [endo_tot' exo_tot'];
