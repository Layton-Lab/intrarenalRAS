...
c_ACE_Tb      = 1.83;        % /min
S_Tb          = 0.241;
k_AGT         = 1737;%1598.07995396778;%739;
...
B_AT1R        = 2.9;
K_circ_ACE    = 3.9;%/scale; % fmol/mL/min
...
p = [W_K,V_circ,V_Gl_Isf,V_Gl_cell,V_Pt_Isf,V_Tb_Pt_cell,V_Tb_Fl,V_Pv,...
     ...
     k_int,k_rec,k_lys,AT1R_Gl_tot,c_chym,c_NEP,v_max,k_AngI_Pt,...
     c_ACE_Pt,k_AngI_Tb,c_ACE_Tb,S_Tb,k_AGT,k_a,B_AT1R,K_circ_ACE,...
     K_circ_AGT,K_Pt,K_Tb,AT1R_circ_tot,AT1R_Pv_tot,...
     AT1R_AngII_memb_Gl_eq,AT1R_AngII_memb_Pt_eq,AT1R_AngII_memb_Tb_eq,...
     AT1R_AngII_memb_circ_eq];
end
